...
export const LoaderProps = () => {
  ...
  const rows = [{
    ...
    description: <Text componentName="standard">Set true to displaying the loader dimmer.</Text>
  }, {
    prop: (<Tag componentName="prop">text</Tag>),
    type: (<Tag componentName="type">string</Tag>),
    default: <Text fontSize="sm" textAlign="center">-</Text>,
    description: <Text componentName="standard">Change the loading text.</Text>
  }]
